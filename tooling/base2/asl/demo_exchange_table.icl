<?xml?>
<class
    name      = "demo_exchange_table"
    comment   = "Implements the hash table container for demo_exchange"
    version   = "1.0"
    script    = "icl_gen"
    >
<doc>
...
<inherit class = "icl_hash_head" >
    ...
    <option name = "childname"  value = "demo_exchange" />
    <option name = "childtype"  value = "demo_exchange_t" />
...
<import class = "demo_exchange" after = "1" />
