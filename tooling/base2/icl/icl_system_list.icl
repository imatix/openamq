<?xml?>
<class
    name      = "icl_system_list"
    comment   = "Implements the list container for icl_system"
    version   = "1.0"
    script    = "icl_gen"
    >
<doc>
...
<inherit class = "icl_list_head" >
    ...
    <option name = "childname"  value = "icl_system" />
    <option name = "childtype"  value = "icl_system_t" />
