<?xml?>
<class
    name      = "icl_mem_thin_list"
    comment   = "Implements the list container for icl_mem_thin"
    version   = "1.0"
    script    = "icl_gen"
    >
<doc>
...
<inherit class = "icl_list_head" >
    ...
    <option name = "childname"  value = "icl_mem_thin" />
    <option name = "childtype"  value = "icl_mem_thin_t" />
