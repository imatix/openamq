<?xml?>
<class
    name      = "ipr_symbol_table"
    comment   = "Implements the hash table container for ipr_symbol"
    version   = "1.0"
    script    = "icl_gen"
    >
<doc>
...
<inherit class = "icl_hash_head" >
    ...
    <option name = "childname"  value = "ipr_symbol" />
    <option name = "childtype"  value = "ipr_symbol_t" />
...
<import class = "ipr_symbol" after = "1" />
