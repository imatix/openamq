...
<class
    name      = "ipr_hash_table"
    comment   = "Implements the hash table container for ipr_hash"
    version   = "1.0"
    script    = "icl_gen"
    >
<doc>
...
<inherit class = "icl_hash_head" >
    ...
    <option name = "childname"  value = "ipr_hash" />
    <option name = "childtype"  value = "ipr_hash_t" />
