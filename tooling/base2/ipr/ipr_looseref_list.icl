<?xml?>
<class
    name      = "ipr_looseref_list"
    comment   = "Implements the list container for ipr_looseref"
    version   = "1.0"
    script    = "icl_gen"
    >
<doc>
...
<inherit class = "icl_list_head" >
    ...
    <option name = "childname"  value = "ipr_looseref" />
    <option name = "childtype"  value = "ipr_looseref_t" />
