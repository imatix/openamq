<?xml?>
<class
    name      = "ipr_nonce_table"
    comment   = "Implements the hash table container for ipr_nonce"
    version   = "1.0"
    script    = "icl_gen"
    >
<doc>
...
<inherit class = "icl_hash_head" >
    ...
    <option name = "childname"  value = "ipr_nonce" />
    <option name = "childtype"  value = "ipr_nonce_t" />
...
<import class = "ipr_nonce" after = "1" />
