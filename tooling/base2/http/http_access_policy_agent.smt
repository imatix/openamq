<?xml?>
<!---------------------------------------------------------------------------
    http_access_policy_agent.smt - http_access_policy component
...
<thread name = "class">
    ...
    <handler name = "thread new">
        <argument name = "self" type = "http_access_policy_t *">The iCL object</argument>
