<?xml?>
<!---------------------------------------------------------------------------
    http_access_refresh_agent.smt - http_access_refresh component
...
<agent
    name = "http_access_refresh_agent"
    script = "smt_gen.gsl"
    animate = "0"
    >
...
<thread name = "class">
    ...
    <handler name = "thread new">
        <argument name = "self" type = "http_access_refresh_t *">The iCL object</argument>
