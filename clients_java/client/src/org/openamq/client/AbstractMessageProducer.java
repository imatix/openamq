 ...
 */
public abstract class AbstractMessageProducer extends Closeable implements org.openamq.jms.MessageProducer
{
    ...
    protected AbstractMessageProducer(AMQDestination destination, boolean transacted, int channelId,
