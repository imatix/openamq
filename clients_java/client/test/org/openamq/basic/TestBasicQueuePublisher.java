 ...
 */
public class TestBasicQueuePublisher
{
	private static final Logger _logger = Logger.getLogger(TestBasicQueuePublisher.class);
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            MessageProducer producer = session.createBasicProducer(destination);
