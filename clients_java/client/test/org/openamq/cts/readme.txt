...
The scripts expect a properly configured IBASE environment. Before attempting to run, the openamqj provider classes must be packaged and installed. The src/compile.sh script will help to achieve that.