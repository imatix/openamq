...
function CalendarPopup_getStyles() {
	var result = "";
	result += "<STYLE>\n";
	result += "TD.cal { font-family:arial; font-size: 10pt; }\n";
	result += "TD.calmonth { font-family:arial; font-size: 10pt; text-align: right;}\n";
	result += "TD.caltoday { font-family:arial; font-size: 10pt; text-align: right; color: white; background-color:#C0C0C0; border-width:1; border-type:solid; border-color:#800000; }\n";
	result += "A.textlink { font-family:arial; font-size: 10pt; height: 20px; color: black; }\n";
	result += ".disabledtextlink { font-family:arial; font-size:108pt; height: 20px; color: #808080; }\n";
