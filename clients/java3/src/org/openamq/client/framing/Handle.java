...
public class Handle
{
    ...
    public static final class Send extends AMQCommandFrame
    {
        ...
        protected long getCommandSize()
        {
            return 2 + 2 + + 2 + 4 + 1 + EncodingUtils.encodedShortStringLength(destName);
        }
    ...
    public static final class Consume extends AMQCommandFrame
    {
        ...
        protected long getCommandSize()
        {
            return 2 + 2 + 2 +2 + 1 + EncodingUtils.encodedShortStringLength(destName) +
    ...
    public static final class Close extends AMQCommandFrame
    {
        ...
        public static final short FRAME_TYPE = 49;
