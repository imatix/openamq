...
public class EncodingUtils
{
    ...
    public static final FieldTable createFieldTableFromMessageSelector(String selector)
    {
    	...
    	for(int i = 0; i < expressions.length; i++)
    	{
    		...
    		{
    			// Existence check
    			result.put(org.openamq.client.message.AbstractMessage.STRING_PROPERTY_PREFIX + expr.trim(),null);
    		}
    		else
    		{
    			...
    			if (value.charAt(0) == '\'')
    			{
    				...
    				else
    				{
    					...
    					result.put(org.openamq.client.message.AbstractMessage.STRING_PROPERTY_PREFIX + key,value);
    				}
    			}
    			else
    			{
    				try
    				{
    					...
    					result.put(org.openamq.client.message.AbstractMessage.INT_PROPERTY_PREFIX + key,value);
    				}
