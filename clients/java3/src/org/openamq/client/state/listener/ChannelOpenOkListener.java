...
import org.openamq.client.framing.ChannelOpenOkBody;
 ...
 */
public class ChannelOpenOkListener extends BlockingCommandFrameListener
{
    private int _channelId;

    public ChannelOpenOkListener(int channelId)
    {
    ...
    public boolean processMethod(short channelId, AMQMethodBody method) throws AMQException
    {
        ...
        {
            return (method instanceof ChannelOpenOkBody);                                                
        }        
        return false;              
    }
}
