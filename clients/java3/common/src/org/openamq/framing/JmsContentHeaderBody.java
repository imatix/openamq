 ...
 */
public class JmsContentHeaderBody extends ContentHeaderBody
{
    private static final Logger _logger = Logger.getLogger(JmsContentHeaderBody.class);
    ...
    public JmsContentHeaderBody()
    {
        classId = 2;
    }

    protected int getPropertyListSize()
    {
    ...
    protected int getPropertyFlags()
    {
        int value = 0;
    ...
    protected void writePropertyListPayload(ByteBuffer buffer)
    {
    ...
    protected void populatePropertiesFromBuffer(ByteBuffer buffer, int propertyFlags) throws AMQFrameDecodingException
    {
