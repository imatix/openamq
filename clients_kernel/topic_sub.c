...
main (int argc, char *argv [])
{
    ...
    amq_field_new_string (fields, "a1", "1");
    amq_field_new_string (fields, "a2", "");
    selector = amq_field_list_flatten (fields);

    in_handle  = amq_sclient_consumer (amq_client, AMQP_SERVICE_TOPIC,
        "*.eur",
        0,                              /*  Prefetch size                    */
        FALSE,                          /*  No-local                         */
        TRUE,                           /*  No-ack                           */
