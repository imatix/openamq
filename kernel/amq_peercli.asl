<?xml version="1.0"?>
<protocol
    comment  = "OpenAMQ peering protocol methods"
    script   = "asl_gen"
    chassis  = "client"
    basename = "amq_peercli"
    caller   = "amq_peering"
    >
<!--
    Specifies the processing for AMQP methods that come in from a peering
    connection.  Note that the 'session' argument in methods is actually the
    reference of an amq_peering object.
    -->
