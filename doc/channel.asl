...
<doc name = "grammar">
    ...
    open-channel        = C:OPEN S:OPENED
    use-channel         = C:FLOW / S:FLOW
                        / C:COMMIT / C:ROLLBACK
                        / S:SYNCH
                        / access / destination / subscription
                        / jms / file / stream
                        / tx / dtx
                        / test
    close-channel       = C:CLOSE S:CLOSED
                        / S:CLOSE C:CLOSED
</doc>
...
<method name = "close" synchronous = "1" expect = "closed">
    ...
    Channel.Closed MUST be discarded.
    </doc>
    <doc name = "rule">
    The peer sending this method MAY use a counter or timeout to detect
    failure of the other peer to respond correctly with Channel.Closed.
    </doc>
    <chassis name = "client" implement = "MUST" />
    <chassis name = "server" implement = "MUST" />
...
<method name = "closed" synchronous = "1">
    ...
    Channel.Closed handshake method SHOULD log the error.
    </doc>
    <chassis name = "client" implement = "MUST" />
    <chassis name = "server" implement = "MUST" />
</method>
